...
namespace WebApplication1.Controllers
{
    ...
    {
        public string userFilePath = @"D:\\C# Mahediali_GIT\\C# Training\\WebApplication1\\DataAccess\\Data\\Users.json";
        ...
        public ActionResult login(Login model)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(userDb))
                {
                    ...
                    {
                        //Generate user token.
                        objResponse.access_token = WebApplication1.Common.CommonMethod.GenerateJSONWebToken(objuser);
                        objResponse.Status = 1;
